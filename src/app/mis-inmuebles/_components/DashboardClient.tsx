    ...
    return (
        <div className="flex-1 overflow-y-auto p-8 relative z-0 flex flex-col items-center">
            <div className="text-left mb-8 w-full max-w-6xl">
                ...
                {isFirstTimer && (
                    <div className="mb-8 bg-gradient-to-r from-[#1A56DB] to-blue-800 rounded-2xl p-6 md:p-8 text-white shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 animate-in fade-in slide-in-from-top-4 duration-500">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none" />
                        <div className="absolute bottom-0 left-0 w-40 h-40 bg-white/5 rounded-full blur-2xl translate-y-1/3 -translate-x-1/3 pointer-events-none" />

                        <div className="relative z-10 flex-1 text-center md:text-left">
                            <div className="inline-flex items-center justify-center p-2 bg-yellow-400/20 text-yellow-300 rounded-xl mb-3 border border-yellow-400/30">
                                <Zap className="w-5 h-5 mr-2" />
                                <span className="font-bold text-sm tracking-wide uppercase">Beneficio Activo</span>
                            </div>
                        ...
                        <Link
                            href="/publicar/tipo"
                            className="relative z-10 w-full md:w-auto px-8 py-4 bg-white text-[#1A56DB] font-extrabold rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transition-all hover:-translate-y-1 flex items-center justify-center gap-2 whitespace-nowrap text-lg"
                        >
