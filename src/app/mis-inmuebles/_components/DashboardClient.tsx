...
import {
    ...
    Search, Plus, Bell, Home, ShieldCheck, CreditCard, Users, LogOut, MapPin, MoreHorizontal, Eye, FileText, CheckCircle, Clock, Pencil
} from 'lucide-react';
...
// =============================================================================
export default function DashboardClient({ user, profile, properties }: DashboardClientProps) {
    // UI State only
